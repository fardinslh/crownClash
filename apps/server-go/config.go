...
func LoadConfig() Config {
	...
	for _, origin := range strings.Split(getenv("CLIENT_ORIGINS", "http://localhost:3000,http://127.0.0.1:3000,http://localhost:5173,http://127.0.0.1:5173,http://localhost:3001,http://127.0.0.1:3001,http://localhost:3002,http://127.0.0.1:3002"), ",") {
